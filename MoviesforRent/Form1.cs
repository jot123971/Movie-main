...
namespace MoviesforRent
{
    public partial class Form1 : Form
    {
        ...
        SqlConnection con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename= " + Application.StartupPath + "\\Moviesforrentdatabase.mdf;Integrated Security=True;Connect Timeout=30;");
        ...
        // this fuction add customer detail...
       ...
       // it shows messagebox.....
        ...
        // this function work for deteting customer detail..
        ...
        // it updating the customer detail.....
        ...
        // this function add mdetail values....
...
SqlCommand cmd = new SqlCommand("INSERT INTO Rdetail VALUES(@rmid,@cridbox,@mridbox,@rentdbox,@retdbox)", con);
        ...
        // it shows popup field are empty messagebox......
